...
dataset_name2                = 'synthia_audi_new' # Second dataset name. None if not Domain Adaptation
perc_mb2                     = 0.5             # Percentage of data from the second dataset in each minibatch
...
debug_images_valid           = 4              # N images for validation in debug mode (-1 means all)
...
save_results_n_legend_rows   = 3               # Number of rows when showwing the legend
...
norm_bgr                           = False     # Convert from RGB to BGR (After all the normalizations)
